package ru.dansh1nv.quiz.list.presentation.composable.location
...
internal fun LocationBottomSheet(
    ...
    ModalBottomSheet(
        onDismissRequest = { onUIEvent(ScreenEvent.BottomSheetDismiss) },
        sheetState = sheetState,
    ) {
        Column(
            modifier = Modifier
            ...
            LazyColumn(
                ...
                items(items) { item ->
                    Text(
                        ...
                        modifier = Modifier
                            .clickable {
                                onUIEvent(BottomSheetEvent.OnLocationClick(item))
                            }
                            .fillMaxWidth()
                            .wrapContentHeight()
